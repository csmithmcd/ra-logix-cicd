...
try {
    ...
    Invoke-Checked `
        ...
        -Arguments @(
            "-c",
            "import sys; raise SystemExit(0 if sys.version_info[:2] in ((3,12),(3,13)) else 12)"
        ) `
        -Description "Validating Python version (3.12 or 3.13)"
    ...
    Invoke-Checked `
        ...
        -Description "Validating virtual environment Python version (3.12 or 3.13)"
